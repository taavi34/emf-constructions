...
export default function HomePage() {
  ...
  const stats = [
    ...
    { value: '5', label: 'Client Rating', star: true },
  ]
  ...
  const featuredProjects = [
    { title: 'The Onyx Residence', category: 'Luxury Residential', slug: 'the-onyx-residence', image: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=800&q=80' },
    { title: 'Maison Noir Kitchen', category: 'Interior Renovation', slug: 'maison-noir-kitchen', image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80' },
    { title: 'Aurum Tower', category: 'Commercial', slug: 'aurum-tower', image: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80' },
  ]
    ...
    <>
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ textAlign: 'center', padding: '120px 2rem 140px', maxWidth: '960px', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '2.2rem', animation: 'fadeIn 1s ease forwards' }}>
            <GoldLine /><span style={{ fontFamily: 'var(--font-jost)', color: '#D4A843', fontSize: '12px', letterSpacing: '0.4em', textTransform: 'uppercase', fontWeight: '500' }}>Building Excellence Since 2009</span><GoldLine />
          </div>
      ...
      <section style={{ padding: '8rem 2rem', background: '#171717' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '5rem', alignItems: 'center' }}>
          ...
          <div ref={addRef} className="reveal">
            ...
            <h2 style={{ fontFamily: 'var(--font-cormorant)', fontSize: 'clamp(2.5rem, 4.5vw, 3.5rem)', fontWeight: '400', color: '#fff', lineHeight: '1.1', marginBottom: '0.3rem' }}>Two Decades of</h2>
            <h2 style={{ fontFamily: 'var(--font-cormorant)', fontSize: 'clamp(2.5rem, 4.5vw, 3.5rem)', fontWeight: '400', lineHeight: '1.1' }}><span className="gold-text" style={{ fontStyle: 'italic' }}>Mastery.</span></h2>
      ...
      <section style={{ padding: '8rem 2rem', background: '#111110' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: '#D4A84314' }} className="services-grid">
            {services.map((s, i) => (
