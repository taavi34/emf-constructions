...
export default function HomePage() {
  ...
  // Restored geometric icons — professional, consistent
  const services = [
  ...
  const stats = [
    ...
    // Fix: render star separately so it never gets clipped
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem', textAlign: 'center' }}>
          {stats.map((s, i) => (
            <div key={i} style={{ padding: '1.2rem 0' }}>
              {/* Render number and star on same line to prevent clipping */}
      ...
      <section style={{ padding: '8rem 2rem', background: '#171717' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '5rem', alignItems: 'center' }}>
          ...
          <div ref={addRef} className="reveal">
            ...
            <h2 style={{ fontFamily: 'var(--font-cormorant)', fontSize: 'clamp(2.5rem, 4.5vw, 3.5rem)', fontWeight: '400', lineHeight: '1.1' }}>
      ...
      <section style={{ padding: '8rem 2rem', background: '#111110' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div ref={addRef} className="reveal" style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <p style={{ fontFamily: 'var(--font-jost)', color: '#bbb', fontSize: '17px', lineHeight: '1.8', fontWeight: '300', maxWidth: '540px', margin: '1.2rem auto 0' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: '#D4A84314' }} className="services-grid">
            {services.map((s, i) => (
              <div key={i} ref={addRef} className="reveal"
                style={{ padding: '2.8rem', background: '#0f0f0f', transition: 'background 0.3s', transitionDelay: `${i * 0.07}s`, cursor: 'default' }}
      ...
      <section style={{ padding: '8rem 2rem', background: '#171717' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0' }} className="process-grid">
            {process.map((step, i) => (
              <div key={i} ref={addRef} className="reveal"
                style={{ padding: '2.5rem 2rem', transitionDelay: `${i * 0.1}s`, borderLeft: i > 0 ? '1px solid #D4A84320' : 'none' }}>
      ...
      <section style={{ padding: '9rem 2rem', background: '#0f0f0f', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', position: 'relative' }}>
          <div ref={addRef} className="reveal">
            ...
            <p style={{ fontFamily: 'var(--font-jost)', color: '#bbb', fontSize: '17px', lineHeight: '1.8', fontWeight: '300', marginBottom: '2.8rem' }}>
