...
const projects: Project[] = [
  {
    ...
    details: 'The Onyx Residence stands as one of our most ambitious residential projects to date. The client envisioned a home that blurred the line between architecture and sculpture — and that is precisely what was delivered. Every surface was considered, every material selected for its tactile quality as much as its visual impact.',
    highlights: ['Blackened steel structural frame', 'Floor-to-ceiling glazing on three facades', 'Bespoke gold-leaf ceiling detailing', 'Heated polished concrete floors', 'Custom-built walnut joinery throughout', 'Infinity-edge pool with automatic cover'],
    images: [
  ...
  },
  {
    ...
    details: 'The Maison Noir Kitchen is a study in contrast — dark hand-finished cabinetry set against luminous Calacatta marble, with aged brass hardware tying every element together. The client wanted a kitchen that felt like a professional chef\'s space without sacrificing the warmth of a family home.',
    highlights: ['Hand-painted lacquer cabinetry in Noir', 'Italian Calacatta Oro marble benchtops', 'Aged brass Waterworks tapware', 'Integrated Gaggenau appliance suite', 'Custom island with under-bench wine storage', 'Concealed pantry with full-height shelving'],
    images: [
  ...
  },
  {
    ...
    details: 'Aurum Tower redefined the downtown skyline with its signature gold-anodised aluminium facade that catches the California sun at every angle. The ground-floor retail precinct was designed to activate the streetscape, while upper floors house premium commercial tenancies with panoramic city views.',
    highlights: ['Gold-anodised aluminium curtain wall system', 'LEED Gold certified construction', '8 floors of premium commercial space', '3 ground-floor retail tenancies', 'Rooftop terrace with 360° views', 'Dedicated end-of-trip cycling facilities'],
    images: [
  ...
  },
  {
    ...
    details: 'The Midnight Spa Bath transformed a dated ensuite into a sanctuary of calm. Book-matched Nero Marquina marble wraps the walls and floor, creating a seamless dark canvas that makes the brushed brass fixtures glow like jewellery. The freestanding soaking tub commands centre stage, fed by a single-lever floor-mounted spout.',
    highlights: ['Book-matched Nero Marquina marble', 'Freestanding Kaldewei soaking tub', 'Floor-mounted brushed brass tapware', 'Hydronic underfloor heating system', 'Frameless steam shower with bench seat', 'Backlit mirror with integrated demister'],
    images: [
  ...
  },
  {
    ...
    details: 'The Foundry Project is a collection of 12 premium residential apartments built on a former light industrial site. The architecture honours the heritage of the site through exposed steel, raw concrete and reclaimed brick, while the interiors offer contemporary luxury. Delivered three weeks ahead of programme.',
    highlights: ['12 premium residential apartments', 'Exposed structural steel and concrete', 'Reclaimed brick feature facades', 'Communal rooftop garden and BBQ', 'Individual basement parking per unit', 'Smart home automation in all apartments'],
    images: [
  ...
  },
  {
    ...
    details: 'The Heritage Stairwell is as much sculpture as it is structure. Each black walnut tread was individually hand-finished over six weeks by our master carpenter. The hand-forged iron balustrade was commissioned from a local blacksmith, with brass cap details adding a final touch of warmth to this striking centrepiece.',
    highlights: ['Solid black walnut floating treads', 'Hand-forged iron balustrade', 'Solid brass cap and handrail details', 'Engineered steel spine structure', 'Individual tread hand-oiling process', 'Integrated LED tread lighting'],
    images: [
  ...
  },
  {
    ...
    details: 'Set on a prominent hillside lot with uninterrupted views from the Hollywood Hills to the Pacific Ocean, The Whitmore Estate is a landmark of contemporary California living. Hand-selected limestone cladding, a 25-metre infinity pool and a full entertainer\'s wing make this one of our most celebrated residential projects.',
    highlights: ['Hand-selected French limestone cladding', '25-metre infinity-edge pool', 'Dedicated home cinema and bar', 'Six-car subterranean garage', 'Fully landscaped 1.2 acre grounds', 'Crestron whole-home automation'],
    images: [
      'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200&q=80',
      'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1200&q=80',
      'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1200&q=80',
  ...
  },
  {
    ...
    category: 'Commercial',
    desc: 'A 12-floor corporate headquarters with biophilic design, custom lighting and rooftop terrace.',
    location: 'Century City, CA',
    year: '2022',
    size: '72,000 sq ft',
    duration: '30 months',
    image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80',
    details: 'The Obsidian Office HQ was designed to attract and retain world-class talent through an environment that prioritises wellbeing, collaboration and inspiration. Biophilic design principles run throughout, from living green walls at every floor to timber-lined breakout zones flooded with natural light.',
    highlights: ['Living green wall installations per floor', 'Timber-lined collaboration zones', 'Full rooftop terrace and garden', 'Wellness floor with gym and meditation rooms', 'Café and restaurant on ground level', 'Electric vehicle charging in all basement levels'],
    images: [
      'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80',
      'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1200&q=80',
      'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200&q=80',
  ...
  },
  {
    ...
    details: 'The Amber Library was commissioned by an avid book collector who wanted a room worthy of their 4,000-volume collection. Floor-to-ceiling American walnut shelving wraps three walls, accessed by a pair of rolling brass-railed library ladders. A bespoke window seat with storage drawers and brass inlay detail completes the room.',
    highlights: ['Floor-to-ceiling American walnut shelving', 'Twin rolling brass-railed library ladders', 'Bespoke window seat with storage', 'Brass inlay detailing throughout', 'Integrated LED strip lighting in shelves', 'Hidden TV and media cabinet behind panel'],
    images: [
  ...
  return (
    <>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '2rem', opacity: visible ? 1 : 0, transition: 'opacity 0.4s ease' }}>
            {filtered.map((project, i) => (
              <div key={project.title} style={{ animation: `cardFadeIn 0.4s ease ${i * 0.06}s both`, cursor: 'pointer' }}
                ...
                <div style={{ background: '#0f0f0f', overflow: 'hidden', boxShadow: '0 8px 40px rgba(212,168,67,0.1)', height: '100%', transition: 'box-shadow 0.3s, transform 0.3s' }}
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.boxShadow = '0 12px 50px rgba(212,168,67,0.22)'; (e.currentTarget as HTMLElement).style.transform = 'translateY(-4px)' }}
                  ...
                  <div style={{ position: 'relative', height: '260px', overflow: 'hidden' }}>
                    <img src={project.image} alt={project.title} style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.6s ease', display: 'block' }}
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'background 0.3s' }}
                      ...
                      <span style={{ fontFamily: 'var(--font-jost)', fontSize: '11px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#fff', fontWeight: '500', opacity: 0, transition: 'opacity 0.3s', background: 'rgba(0,0,0,0.5)', padding: '8px 18px', border: '1px solid #D4A84366' }}
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '0.5rem', padding: '1rem 1.5rem', background: '#0f0f0f', overflowX: 'auto' }}>
              {selectedProject.images.map((img, i) => (
                <div key={i} onClick={() => setActiveImage(i)}
                  style={{
                    width: '80px', height: '56px', flexShrink: 0, overflow: 'hidden',
                    border: activeImage === i ? '2px solid #D4A843' : '2px solid transparent',
                    cursor: 'pointer', transition: 'border-color 0.2s', opacity: activeImage === i ? 1 : 0.55,
                  }}>
            ...
            <div style={{ padding: '2rem 2rem 2.5rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', marginBottom: '1.5rem' }}>
                <div>
                  <div style={{ fontFamily: 'var(--font-jost)', color: '#D4A843', fontSize: '10px', letterSpacing: '0.3em', textTransform: 'uppercase', fontWeight: '500', marginBottom: '6px' }}>
                    {selectedProject.category}
                  </div>
                  <h2 style={{ fontFamily: 'var(--font-cormorant)', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: '400', color: '#fff', lineHeight: '1.1' }}>
                ...
                <div style={{ display: 'flex', gap: '2rem', flexShrink: 0 }}>
                  {[
                    ...
                    { label: 'Completed', value: selectedProject.year },
                    { label: 'Size', value: selectedProject.size },
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2.5rem' }}>
                <div>
                  ...
                  <p style={{ fontFamily: 'var(--font-jost)', color: '#bbb', fontSize: '15px', lineHeight: '1.9', fontWeight: '300' }}>
              ...
              <div style={{ marginTop: '2.5rem', paddingTop: '2rem', borderTop: '1px solid #1e1e1c', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                <p style={{ fontFamily: 'var(--font-cormorant)', color: '#888', fontSize: '1.1rem', fontStyle: 'italic' }}>
                  Interested in a similar project?
                </p>
                <Link href="/quote" className="btn-gold" onClick={() => setSelectedProject(null)}>
                  Start Your Project →
                </Link>
              </div>
            </div>
      ...
      <style jsx global>{`
        ...
        .view-label { pointer-events: none; }
        div:hover .view-label { opacity: 1 !important; }
